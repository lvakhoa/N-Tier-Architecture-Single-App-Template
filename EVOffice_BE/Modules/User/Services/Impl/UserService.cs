...
namespace EVOffice_BE.Modules.User.Services.Impl;
...
public class UserService : IUserService
{
    ...
    public async Task<CreateUserResponseModel> CreateAsync(CreateUserModel createUserModel)
    {
        ...
        await _emailService.SendEmailAsync(EmailMessage.Create(user.Email, emailBody, "[EVOffice_BE]Confirm your email"));
